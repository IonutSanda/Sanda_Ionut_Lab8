...
namespace Sanda_Ionut_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Sanda_Ionut_Lab8Context context, Book book)
        {
        ...
        public void updateBookCategories(Sanda_Ionut_Lab8Context context, string[] selectedCategories, Book bookToUpdate) { 
